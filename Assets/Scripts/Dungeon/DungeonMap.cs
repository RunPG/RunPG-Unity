...
{ 
    ...
    public static List<List<Room>> GenerateMap(int seed)
    {
        ...
        //    map.Add(row);
        //}
        map.Add(new List<Room>() { new FightRoom(DungeonManager.instance.generateFightEnemies(1)), new BonusRoom() });
        map.Add(new List<Room>() { new FightRoom(DungeonManager.instance.generateFightEnemies(2)), new FightRoom(DungeonManager.instance.generateFightEnemies(2)), new FightRoom(DungeonManager.instance.generateFightEnemies(2)) });
        map.Add(new List<Room>() { new HealRoom(), new BonusRoom() });
